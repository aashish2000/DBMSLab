...
cid number(2) constraint cpkey primary key,
lname char(20),
fname char(20)
);

create table products(
pid varchar2(15) constraint ppkey primary key,
flavor char(15),
food char(15),
price float(10)
);
...
rno number(5) constraint rpkey primary key,
rdate date,
cid number(2) constraint cref references customers(cid)
);

create table item_list(
rno number(5) constraint rref references Receipts(rno),
ordinal number(1),
item varchar2(15) constraint iref references products(pid),
constraint ilpkey primary key(rno, ordinal)
);
